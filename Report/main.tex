...
Having estimated the gaussian mixture models $(\boldsymbol{\Phi}_1, \boldsymbol{\Phi}_2$
for each of our sources, we now turn to the problem of recovering the set of orignial signals
from the mixed spectrogram 
